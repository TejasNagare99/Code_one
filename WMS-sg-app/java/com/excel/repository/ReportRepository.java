...
public interface ReportRepository {
	...
	//Pending Dispatch intimation email
		List<DispatchIntimationEmail> getDispatchIntimationEmail(String stdate , String endate);
	...
	List<BatchwiseStockStmtReport> getBatchwiseStockStmtData(ReportBean bean, String stk_ind) throws Exception;
	...
	List<Stock_Statement_Non_Sale> getDataStkNonsalable(ReportBean bean) throws Exception; 
	List<Stock_Reco_With_sfa> getStockrecowithsfa()throws Exception;
	...
	List<Sap_Dispatch_Download> getSapDispatchDownloadData(ReportBean rb, String startDate, String endDate) throws Exception;
	List<LrcsvDownload> getLrcsvdownload_data(String strdate, String enddate, String tbl_ind, String cfa,
		    String fsid, String stock_at_cfa_ind,String stk_at_cfa_option,String temp,String deploc)throws Exception;
	...
	List<Object[]> get_employee_list(long div, int loc, String stdt, String endt,String fstaff_id, int cfaLoc, String desg_id
			,String fstaffId_o,String deleted_inv,String emp_id,String deptloc,String finyearflag,String year) throws Exception;
	...
	List<SmpItem> getStockType(String empId) throws Exception;
	...
	List<LrcsvDownloadReportRevised> get_Lrcsv_revised_data(ReportBean bean,String tabl_ind,String cfa,String fsid,String fstype,String deptloc,String temp)throws Exception;
	List<Lrcsv_RevisedDownload> getLrcsvdownload_Revised_data(String strdate, String enddate, String tbl_ind, String cfa,
		    String fsid, String stock_at_cfa_ind,String stk_at_cfa_option,String temp,String deptloc,List<String> loc,
		    List<String> div,List<String> dest,String cfa_to_stockist_ind)throws Exception;
	...
	List<DIV_TEAM_BRAND> getDivDataForTeamBrand(String userId, String divId) throws Exception;
	void getDeleteDivDataForTeamBrand( String teamcode);
	...
	List<Scheme_Summary> generateSchemeSummary(String scheme_ids, String finyear, String finyear_flag) throws Exception;
	...
	List<ArticleSchemeSummaryReportCfa> articleSchemeSummaryReportCfa(ReportBean bean, String formattedStringLoc, String resultTrd_sch_slno, String formattedSaleProd) throws Exception;
	...
	List<IAADetailReport_SG> getIAADetailReportData_for_sg(String locId, String startDate, String endDate) throws Exception;

	List<IAADetailReport_SG> getIAADetailReportPreviousData_for_sg(String locId, String startDate, String endDate);
	...
	List<Csv_File_List_Without_state_name> get_Csv_File_Consolidated_List_Without_State_Name(String id);
	...
	List<Stock_Statement_Non_Sale_VET> getDataStkNonsalable_VET(ReportBean bean);

	List<Scheme_Summary> getSchemeSummary_drill_down_list(List<String> schemeIds);

	List<Scheme_Summary> generateSchemeSummary_drill_down(String formattedString, String finyear, String finyear_flag);
