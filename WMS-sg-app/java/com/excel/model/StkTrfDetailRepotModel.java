...
@Entity
@Table(name = "STOCK_TRANSFER_DETAIL_TABLE")
@NamedStoredProcedureQuery(name = "STOCK_TRANSFER_DETAIL_REPORT", 
procedureName = "STOCK_TRANSFER_DETAIL_REPORT",
parameters = {
...
}, resultClasses = StkTrfDetailRepotModel.class)
public class StkTrfDetailRepotModel implements Serializable {
