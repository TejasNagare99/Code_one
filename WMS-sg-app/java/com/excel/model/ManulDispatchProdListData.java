...
@Entity
@Table(name = "ManulDispatchProdListData")
@NamedStoredProcedureQuery(name = "callManulDispatchProdListData", 
	procedureName = "p_g_split_manualdispatch_ALLOC_TYPE",
	parameters = {
			...
			@StoredProcedureParameter(name = "piprod_id" , mode = ParameterMode.IN, type = Long.class),
			@StoredProcedureParameter(name = "pimsr_id" , mode = ParameterMode.IN, type = Long.class),
	...
	}, resultClasses = ManulDispatchProdListData.class)
...
public class ManulDispatchProdListData {
	/*
	 * @Id
	 * 
