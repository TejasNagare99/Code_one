...
@Entity
@Table(name="E_INVOICE_HEADER_STOCKIST")
public class EInvoiceHeaderStockist {
	...
	public EInvoiceHeaderStockist() {
		super();
	}

	public EInvoiceHeaderStockist(Long trn_id, String trn_number) {
		super();
		this.trn_id = trn_id;
		this.trn_number = trn_number;
	}
	...
	public String toString() {
		return "EInvoiceHeader [slno=" + slno + ", comp_code=" + comp_code + ", fin_year_id=" + fin_year_id
				+ ", trn_type=" + trn_type + ", trn_id=" + trn_id + ", trn_number=" + trn_number + ", trn_action_type="
				+ trn_action_type + ", trn_date=" + trn_date + ", trn_result=" + trn_result + ", trn_ack_no="
				+ trn_ack_no + ", trn_ack_date=" + trn_ack_date + ", trn_irn_number=" + trn_irn_number
				+ ", trn_inv_sign=" + trn_inv_sign + ", trn_qr_code=" + trn_qr_code + ", trn_status=" + trn_status
				+ ", trn_ewaybillno=" + trn_ewaybillno + ", trn_ewaybilldt=" + trn_ewaybilldt + ", trn_ewaybillvalid="
				+ trn_ewaybillvalid + ", ewaybillcancel=" + ewaybillcancel + ", irncancel=" + irncancel + ", div_id="
				+ div_id + ", einvoice_tranid=" + einvoice_tranid + "]";
	}
