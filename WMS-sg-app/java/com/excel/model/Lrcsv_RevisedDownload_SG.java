...
@NamedStoredProcedureQuery(name = "call_LR_csv_revised_download_sg", //procedureName = "LR_CSV_UPLOAD_PROC_JAVA_REVISED",
...
parameters= {
		...
		},resultClasses=Lrcsv_RevisedDownload_SG.class) 




@Entity
@Table(name = "LR_CSV_UPLOAD_PROC_JAVA_REVISED")
public class Lrcsv_RevisedDownload_SG {
	@Id
	@Column(name = "SR_NO")
	private Long sr_no;
...
//	private String dsp_trans_gst_reg_no;
	...
	@Column(name ="DTL_PINCODE")
	private String dtl_pincode;
	
	
	public String getDtl_pincode() {
		return dtl_pincode;
	}
	public void setDtl_pincode(String dtl_pincode) {
		this.dtl_pincode = dtl_pincode;
	}
