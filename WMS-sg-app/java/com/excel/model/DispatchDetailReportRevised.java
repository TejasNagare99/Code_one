...
@Entity
@Table(name = "DispatchDetailReportNew")
@NamedStoredProcedureQuery(name = "callDispatchDetailsrevised", 
	//procedureName = "dispatch_details_revised",
	procedureName = "dispatch_details_revised_RATEOPTION",
	parameters = {
	...
	}, resultClasses = DispatchDetailReportRevised.class)


@NamedStoredProcedureQuery(name = "callDispatchDetailsnew", 
	procedureName = "dispatch_details_new",
	parameters = {
			@StoredProcedureParameter(name = "div_id" , mode = ParameterMode.IN, type = String.class),
			@StoredProcedureParameter(name = "startdate" , mode = ParameterMode.IN, type = String.class),
			@StoredProcedureParameter(name = "endDate" , mode = ParameterMode.IN, type = String.class),
...
public class DispatchDetailReportRevised {
	...
	public String toString() {
		return "DispatchDetailReportRevised [row=" + row + ", sumdsp_id=" + sumdsp_id + ", div_disp_nm=" + div_disp_nm
				+ ", div_map_cd=" + div_map_cd + ", sumdsp_challan_no=" + sumdsp_challan_no + ", sumdsp_challan_dt="
				+ sumdsp_challan_dt + ", sumdsp_destination=" + sumdsp_destination + ", sumdsp_total_goods_val="
				+ sumdsp_total_goods_val + ", sumdsp_transporter=" + sumdsp_transporter + ", sumdsp_lr_no="
				+ sumdsp_lr_no + ", sumdsp_lr_dt=" + sumdsp_lr_dt + ", sumdsp_totcases=" + sumdsp_totcases
				+ ", dspfstaff_employeeno=" + dspfstaff_employeeno + ", dspfstaff_displayname=" + dspfstaff_displayname
				+ ", dspfstaff_desg=" + dspfstaff_desg + ", hq_name=" + hq_name + ", terr_code=" + terr_code
				+ ", terr_name=" + terr_name + ", dsp_challan_no=" + dsp_challan_no + ", dsp_challan_dt="
				+ dsp_challan_dt + ", dsp_total_goods_val=" + dsp_total_goods_val + ", dsp_transporter="
				+ dsp_transporter + ", dsp_lr_no=" + dsp_lr_no + ", dsp_lr_dt=" + dsp_lr_dt + ", dsp_cases=" + dsp_cases
				+ ", smp_prod_cd=" + smp_prod_cd + ", smp_prod_name=" + smp_prod_name + ", smp_prod_type="
				+ smp_prod_type + ", batch_no=" + batch_no + ", batch_expiry_dt=" + batch_expiry_dt
				+ ", dspdtl_disp_qty=" + dspdtl_disp_qty + ", dspdtl_rate=" + dspdtl_rate + ", value=" + value
				+ ", warehouse=" + warehouse + ", position=" + position + ", mobile=" + mobile + ", dsp_act_wt="
				+ dsp_act_wt + ", dsp_bill_wt=" + dsp_bill_wt + ", sum_dsp_act_wt=" + sum_dsp_act_wt
				+ ", sum_dsp_bill_wt=" + sum_dsp_bill_wt + ", state_name=" + state_name + ", region=" + region
				+ ", month_of_use=" + month_of_use + ", return_qty=" + return_qty + ", dm_name=" + dm_name
				+ ", tentative_delivery_date=" + tentative_delivery_date + ", actual_delivery_date="
				+ actual_delivery_date + ", recieved_by=" + recieved_by + ", courier_comment=" + courier_comment
				+ ", remarks=" + remarks + ", emer_dtd_supplied_to=" + emer_dtd_supplied_to + ", team_code=" + team_code
				+ ", srt_number=" + srt_number + ", srt_date=" + srt_date + ", srt_remark=" + srt_remark
				+ ", dspfstaff_destination=" + dspfstaff_destination + "]";
	}
