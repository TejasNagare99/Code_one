...
@Entity
@Table(name = "Csv_File_Consolidated_List")
@NamedStoredProcedureQuery(
		name="callALLOC_Consolidated_CSV_DOWNLOAD",
		procedureName = "ALLOC_CONSOLIDATED_CSV_DOWNLOAD",
		resultClasses = Csv_File_Consolidated_List.class,
		parameters = {
				@StoredProcedureParameter(name="palloc_con_id", mode = ParameterMode.IN, type = String.class)
		}
)
public class Csv_File_Consolidated_List {
	@Id
	@Column(name = "Row")
	private long Row;
	...
	public String getAlloc_con_id() {
		return alloc_con_id;
	}

	public void setAlloc_con_id(String alloc_con_id) {
