...
@Entity
@Table(name = "dispatch_register_report2_with_parameters")
@NamedStoredProcedureQuery(name = "call_dispatch_register_report2_with_parameters", 
procedureName = "DISPATCH_REGISTER_REPORT2_WITH_PARAMETERS",
parameters = {
...
}, resultClasses = dispatch_register_report2_with_parameters.class)

public class dispatch_register_report2_with_parameters implements Serializable {
