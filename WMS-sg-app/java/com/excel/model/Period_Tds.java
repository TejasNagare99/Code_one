...
@Entity
@Table(name="PERIOD_TDS")
public class Period_Tds {
	...
	public Period_Tds(String period_name) {
		super();
		this.period_name = period_name;
	}
	...
	public String toString() {
		return "Period_Tds [period_id=" + period_id + ", period_company=" + period_company + ", period_fin_year="
				+ period_fin_year + ", period_code=" + period_code + ", period_name=" + period_name
				+ ", period_alt_name=" + period_alt_name + ", period_start_date=" + period_start_date
				+ ", period_end_date=" + period_end_date + ", period_current=" + period_current + ", period_map_cd="
				+ period_map_cd + ", period_monthclose=" + period_monthclose + ", period_ins_usr_id="
				+ period_ins_usr_id + ", period_mod_usr_id=" + period_mod_usr_id + ", period_ins_dt=" + period_ins_dt
				+ ", period_mod_dt=" + period_mod_dt + ", period_ins_ip_add=" + period_ins_ip_add
				+ ", period_mod_ip_add=" + period_mod_ip_add + ", period_status=" + period_status + "]";
	}
