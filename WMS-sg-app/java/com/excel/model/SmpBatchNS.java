...
@Entity
@Table(name = "SMPBatch_NS")
@SelectBeforeUpdate(value = false)
public class SmpBatchNS implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2137161684984000937L;
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="BATCH_SRNO")
	private Long batch_srno;
	...
	public Long getBatch_srno() {
		return batch_srno;
	}
	public void setBatch_srno(Long batch_srno) {
		this.batch_srno = batch_srno;
	}
