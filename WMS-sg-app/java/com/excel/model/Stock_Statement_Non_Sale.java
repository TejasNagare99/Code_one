...
@NamedStoredProcedureQuery(name = "STOCK_STATEMENT_NONSALEABLE", 
	...
	}, resultClasses = Stock_Statement_Non_Sale.class)
public class Stock_Statement_Non_Sale {
	...
	public String toString() {
		return "Stock_Statement_Non_Sale [row=" + row + ", smp_std_div_id=" + smp_std_div_id + ", team=" + team
				...
				+ ", expiry_date=" + expiry_date + ", batch_with_held_qty=" + batch_with_held_qty + ", in_ward_total="
