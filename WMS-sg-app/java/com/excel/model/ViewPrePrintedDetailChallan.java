...
@Entity
@Table(name="ViewPrePrintedChallan")

@NamedStoredProcedureQuery(name = "callPrePrintedDetailChallan",
						   procedureName = "PrePrintedDetailChallan",
							parameters= {
							...
							}, resultClasses = ViewPrePrintedDetailChallan.class)

@NamedStoredProcedureQuery(name = "callPrePrintedSummaryChallan",
procedureName = "PrePrintedSummaryChallan",
	parameters= {
			@StoredProcedureParameter(name = "div_id" ,mode = ParameterMode.IN,type=String.class),
			@StoredProcedureParameter(name = "loc_id" ,mode = ParameterMode.IN,type=String.class),
			@StoredProcedureParameter(name = "frm_challan_no" ,mode = ParameterMode.IN,type=String.class),
...
public class ViewPrePrintedDetailChallan implements Serializable {
