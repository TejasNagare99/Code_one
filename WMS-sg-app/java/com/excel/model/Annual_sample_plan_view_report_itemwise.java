...
@Entity
@Table(name = "Annual_sample_plan_view_report_itemwise")
@NamedStoredProcedureQuery(name = "call_annual_sample_plan_view_report_itemwise",
procedureName = " ANNUAL_SAMPLE_PLAN_VIEW_REPORT_REVISED_INMKT_ISTOCK",
	parameters= {
	...
	}, resultClasses = Annual_sample_plan_view_report_itemwise.class)
public class Annual_sample_plan_view_report_itemwise {
	...
	public Long getIstock() {
		return istock;
	}

	public void setIstock(Long istock) {
		this.istock = istock;
	}
