...
@Entity
@Table(name = "DispatchDetailReport")
@NamedStoredProcedureQuery(name = "callDispatchDetailReport", 
	procedureName = "DISPATCH_DETAILS",
	parameters = {
	...
	}, resultClasses = DispatchDetailReport.class)
public class DispatchDetailReport implements Serializable {
