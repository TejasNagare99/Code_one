...
@Entity
@Table(name = "GenerateDispatchData")
@NamedStoredProcedureQuery(
		name="callGenerateDispatchData",
		procedureName = "p_gen_dispatch_java",
		resultClasses = GenerateDispatchData.class,
		parameters = {
...
public class GenerateDispatchData {
	...
	private BigDecimal pack_disp_nm;
	...
	public BigDecimal getPack_disp_nm() {
		return pack_disp_nm;
	}

	public void setPack_disp_nm(BigDecimal pack_disp_nm) {
