...
@Entity
@Table(name="PrePrintedDetailChallan_withgstPG")
@NamedStoredProcedureQuery(name = "callPrePrintedDetailChallan_withgstPg", procedureName = "PrePrintedDetailChallan_WITHGST",
parameters= {
		...
		},resultClasses=PrePrintedDetailChallan_withgstPG.class) 
public class PrePrintedDetailChallan_withgstPG {
