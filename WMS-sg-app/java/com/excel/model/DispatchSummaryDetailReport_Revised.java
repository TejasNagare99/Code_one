...
@Entity
@Table(name = "DispatchSummaryDetailReport_Revised")
@NamedStoredProcedureQuery(name = "callDispatchSummaryDetailReportRevised", 
	...
	}, resultClasses = DispatchSummaryDetailReport_Revised.class)



@NamedStoredProcedureQuery(name = "callDispatchSummaryDetailReportRevisedPAL", 
procedureName = "dispatch_details_revised",
parameters = {
		@StoredProcedureParameter(name = "div_id" , mode = ParameterMode.IN, type = String.class),
		@StoredProcedureParameter(name = "startdate" , mode = ParameterMode.IN, type = String.class),
...
public class DispatchSummaryDetailReport_Revised {
