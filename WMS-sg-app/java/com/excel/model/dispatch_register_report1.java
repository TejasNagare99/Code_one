...
@Entity
@Table(name = "dispatch_register_report1")
@NamedStoredProcedureQuery(name = "dispatch_register_report1", 
procedureName = "dispatch_register_report1",
parameters = {
...
}, resultClasses = dispatch_register_report1.class)

public class dispatch_register_report1 implements Serializable {
