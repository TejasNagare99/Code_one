...
@Entity
@Table(name = "SUM_DISP_DETAIL_ARC")
@DynamicUpdate(value=true)
@SelectBeforeUpdate(value=true)
public class Sum_Disp_Detail_Arc {
	...
	@Column(name="SUMDSPDTL_FIN_YEAR")
	private String sumdspdtl_fin_year;

	
	
	public String getSumdspdtl_fin_year() {
		return sumdspdtl_fin_year;
	}

	public void setSumdspdtl_fin_year(String sumdspdtl_fin_year) {
		this.sumdspdtl_fin_year = sumdspdtl_fin_year;
	}
