...
@Entity
@Table(name="Allocation_report_2")
@NamedStoredProcedureQuery(
		name="Allocation_report_2",
				procedureName = "ANG_ALLOC_REPORT2_WITHPARM",
				parameters = {
		...
		resultClasses = Allocation_report_2.class
)
@NamedStoredProcedureQuery(
		name="Allocation_report_2_current",
				procedureName = "ANG_ALLOC_REPORT2_WITHPARM_CURRENT",
				parameters = {
						@StoredProcedureParameter(name = "pdiv_id", mode = ParameterMode.IN, type = String.class),
						@StoredProcedureParameter(name = "pfin_year", mode = ParameterMode.IN, type = String.class),
						@StoredProcedureParameter(name = "pperiod_code" , mode = ParameterMode.IN, type = String.class),
...
@NamedStoredProcedureQuery(
		name="Allocation_report_2_previous",
				procedureName = "ANG_ALLOC_REPORT2_WITHPARM_ARCHIEVE",
				parameters = {
						@StoredProcedureParameter(name = "pdiv_id", mode = ParameterMode.IN, type = String.class),
						@StoredProcedureParameter(name = "pfin_year", mode = ParameterMode.IN, type = String.class),
						@StoredProcedureParameter(name = "pperiod_code" , mode = ParameterMode.IN, type = String.class),
...
public class Allocation_report_2 {
