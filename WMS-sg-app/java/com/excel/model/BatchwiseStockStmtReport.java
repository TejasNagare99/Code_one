...
@NamedStoredProcedureQuery(name = "callBatchwiseStockStmtReportFor_stockist_to_cfa", 
procedureName = "ARTICLE_BATCH_STOCK_DETAIL",
parameters = {
...
}, resultClasses = BatchwiseStockStmtReport.class)

public class BatchwiseStockStmtReport implements Serializable {
	...
	public String toString() {
		return "BatchwiseStockStmtReport [row=" + row + ", Div_Id=" + Div_Id + ", div_disp_nm=" + div_disp_nm
				...
				+ cog_rate + ", batch_with_held_qty=" + batch_with_held_qty + ", batch_loc_id=" + batch_loc_id
				+ ", loc_nm=" + loc_nm + "]";
	}
