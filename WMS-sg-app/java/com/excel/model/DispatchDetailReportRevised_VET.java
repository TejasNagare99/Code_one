...
@Entity
@Table(name = "dispatch_details_revised_RATEOPTION")
@NamedStoredProcedureQuery(name = "callDispatchDetailsrevised_VET", 
	...
	}, resultClasses = DispatchDetailReportRevised_VET.class)

public class DispatchDetailReportRevised_VET {
