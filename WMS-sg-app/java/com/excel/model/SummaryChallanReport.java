...
@Entity
@Table(name = "SummaryChallanReport")
@NamedStoredProcedureQuery(name = "callSummaryChallanReport", 
	procedureName = "dispatch_details_SUMMARY_DETAIL_GST",
	parameters = {
	...
	}, resultClasses = SummaryChallanReport.class)
public class SummaryChallanReport implements Serializable {
