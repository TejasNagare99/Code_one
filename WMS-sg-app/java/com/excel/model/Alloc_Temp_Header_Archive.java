...
@Entity
@Table(name = "ALLOC_TEMP_HEADER_ARCHIVE")
public class Alloc_Temp_Header_Archive {
	...
	@Column(name = "NEW_MOD_USER")
	private String new_mod_user;
	
	@Column(name = "NEW_MOD_DATE")
	...
	public String getNew_mod_user() {
		return new_mod_user;
	}

	public void setNew_mod_user(String new_mod_user) {
		this.new_mod_user = new_mod_user;
	}
	...
	public void setNew_mod_date(Date new_mod_date) {
		this.new_mod_date = new_mod_date;
	}
