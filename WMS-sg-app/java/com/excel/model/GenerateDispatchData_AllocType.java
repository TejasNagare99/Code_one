...
@Entity
@Table(name = "GenerateDispatchData_AllocType")
@NamedStoredProcedureQuery(
		name="callGenerateDispatchDataAllocType",
		procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM",
	//			procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM_TKEY",
		resultClasses = GenerateDispatchData_AllocType.class,
		parameters = {
				...
				@StoredProcedureParameter(name="pcProd_id", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pcProd_subtypid", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pcTeam_code", mode = ParameterMode.IN, type = String.class)
		}
)

@NamedStoredProcedureQuery(
		name="callGenerateDispatchDataAllocType_tkey",
	//	procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM",
		procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM_TKEY",
		resultClasses = GenerateDispatchData_AllocType.class,
		parameters = {
...
@NamedStoredProcedureQuery(
		name="callGenerateDispatchDataAllocTypeveto",
		procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM_VETO",
		resultClasses = GenerateDispatchData_AllocType.class,
		parameters = {
				@StoredProcedureParameter(name="pcDSP_COMPANY", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pcDSP_FIN_YEAR", mode = ParameterMode.IN, type = String.class),
...
@NamedStoredProcedureQuery(
		name="callGenerateDispatchDataAllocTypebulkDoc",
		procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM_BULKDOC",
		resultClasses = GenerateDispatchData_AllocType.class,
		parameters = {
				@StoredProcedureParameter(name="pcDSP_COMPANY", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pcDSP_FIN_YEAR", mode = ParameterMode.IN, type = String.class),
				...
				@StoredProcedureParameter(name="pcProd_subtypid", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pcTeam_code", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pi_BLK_HCP_REQ_ID", mode = ParameterMode.IN, type = Long.class)
		}
)

@NamedStoredProcedureQuery(
		name="callGenerateDispatchDataAllocTypebulkStk",
		procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM_BULKSTOCKIST",
		resultClasses = GenerateDispatchData_AllocType.class,
		parameters = {
				@StoredProcedureParameter(name="pcDSP_COMPANY", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pcDSP_FIN_YEAR", mode = ParameterMode.IN, type = String.class),
...
@NamedStoredProcedureQuery(
		name="callGenerateDispatchDataAllocTypeSingleStk",
		procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM_SINGLESTOCKIST_23jul_TRD",
		//procedureName = "p_gen_dispatch_java_ALLOC_TYPE_PRODSELC_PRDSUBTYPEID_TEAM_SINGLESTOCKIST_23jul_TRD_CORR",
		resultClasses = GenerateDispatchData_AllocType.class,
		parameters = {
				@StoredProcedureParameter(name="pcDSP_COMPANY", mode = ParameterMode.IN, type = String.class),
				@StoredProcedureParameter(name="pcDSP_FIN_YEAR", mode = ParameterMode.IN, type = String.class),
...
public class GenerateDispatchData_AllocType {
