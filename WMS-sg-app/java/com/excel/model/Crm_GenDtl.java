...
@Entity
@Table(name = "CRM_GEN_DTL")
public class Crm_GenDtl {
	@Id
	...
	public Long getCrm_cust_id() {
		return crm_cust_id;
	}

	public void setCrm_cust_id(Long crm_cust_id) {
	...
	public Date getCrm_exps_date() {
		return crm_exps_date;
	}

	public void setCrm_exps_date(Date crm_exps_date) {
