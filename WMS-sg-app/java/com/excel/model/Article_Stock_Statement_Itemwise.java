...
@Entity
@Table(name = "ARTICLE_STOCK_STATEMENT_ITEMWISE")
@NamedStoredProcedureQuery(name = "callARTICLE_STOCK_STATEMENT_ITEMWISE",
		// procedureName = "STOCK_STATEMENT_FCODE",
		procedureName = "ARTICLE_STOCK_STATEMENT_ITEMWISE_WITHOUTFYEAR", 
//				procedureName = "ARTICLE_STOCK_STATEMENT_ITEMWISE", 
		...
		parameters = {
				...
				@StoredProcedureParameter(name = "fin_year_id", mode = ParameterMode.IN, type = String.class)}, resultClasses = Article_Stock_Statement_Itemwise.class)
public class Article_Stock_Statement_Itemwise {
...
//	}
	...
	public String toString() {
		return "Article_Stock_Statement_Itemwise [row=" + row + ", team=" + team + ", loc_id=" + loc_id + ", loc_name="
				+ loc_name + ", smp_prod_id=" + smp_prod_id + ", product_code=" + product_code + ", article_name="
				+ article_name + ", unit_price=" + unit_price + ", opening_qty="
				...
				+ ", cl_stock_val=" + cl_stock_val + ", with_held_qty=" + with_held_qty + ", pending=" + pending
				+ ", grnqty=" + grnqty + ", disp_qty=" + disp_qty + ", adjdtl_in_qty=" + adjdtl_in_qty
				+ ", adjdtl_out_qty=" + adjdtl_out_qty + ", trf_out_qty=" + trf_out_qty + "]";
	}
