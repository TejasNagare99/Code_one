...
@Entity
@Table(name="ASP_HEADER")
@DynamicUpdate(value=true)
public class AspHeader implements Serializable{
	...
	private String mgr_emp_id;

	@Column(name="ASSIS_APPR_STATUS")
	private String assis_appr_status;
	
	@Column(name="ALLOC_CON_DTL_ID_T")
	private Long alloc_con_dtl_id_t;
	...
	@Column(name="ALLOC_CON_DOCNO_C")
	private String alloc_con_docno_c;
	
	@Column(name="ALLOC_CON_DTL_ID_C")
	private Long alloc_con_dtl_id_c;
	
	@Column(name="ALLOC_CON_ID_C")
	private Long alloc_con_id_c;
	...
	public String getMgr_emp_id() {
		return mgr_emp_id;
	}

	public void setMgr_emp_id(String mgr_emp_id) {
		this.mgr_emp_id = mgr_emp_id;
	}

	public String getAssis_appr_status() {
		return assis_appr_status;
	}

	public void setAssis_appr_status(String assis_appr_status) {
		this.assis_appr_status = assis_appr_status;
	}

	public Long getAlloc_con_dtl_id_t() {
		return alloc_con_dtl_id_t;
	}

	public void setAlloc_con_dtl_id_t(Long alloc_con_dtl_id_t) {
		this.alloc_con_dtl_id_t = alloc_con_dtl_id_t;
	}
	...
	public String getAlloc_con_docno_c() {
		return alloc_con_docno_c;
	}

	public void setAlloc_con_docno_c(String alloc_con_docno_c) {
		this.alloc_con_docno_c = alloc_con_docno_c;
	}

	public Long getAlloc_con_dtl_id_c() {
		return alloc_con_dtl_id_c;
	}

	public void setAlloc_con_dtl_id_c(Long alloc_con_dtl_id_c) {
		this.alloc_con_dtl_id_c = alloc_con_dtl_id_c;
	}

	public Long getAlloc_con_id_c() {
		return alloc_con_id_c;
	}

	public void setAlloc_con_id_c(Long alloc_con_id_c) {
		this.alloc_con_id_c = alloc_con_id_c;
	}
