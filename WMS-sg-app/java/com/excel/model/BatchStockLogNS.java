...
@Entity
@Table(name="BATCH_STOCK_LOG_NS")
@DynamicUpdate(value=true)
public class BatchStockLogNS implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 6720842847765720592L;
	...
	@Column(name="BTCHSTKLG_STOCK_TYPE")
	private String btchstklg_stock_type;
	...
	public String getBtchstklg_stock_type() {
		return btchstklg_stock_type;
	}

	public void setBtchstklg_stock_type(String btchstklg_stock_type) {
		this.btchstklg_stock_type = btchstklg_stock_type;
	}
