...
@Entity
@Table(name = "Annual_sample_plan_view_report_batchwise")
@NamedStoredProcedureQuery(name = "call_annual_sample_plan_view_report_batchwise",
procedureName = "ANNUAL_SAMPLE_PLAN_VIEW_REPORT_REVISED_INMKT_BSTOCK",
	parameters= {
			@StoredProcedureParameter(name = "FINYEAR" ,mode = ParameterMode.IN,type=String.class),
			@StoredProcedureParameter(name = "ASP_DIVID" ,mode = ParameterMode.IN,type=String.class),
			@StoredProcedureParameter(name = "ASP_BRAND_ID" ,mode = ParameterMode.IN,type=String.class),
			@StoredProcedureParameter(name = "ASP_PROD_ID" ,mode = ParameterMode.IN,type=String.class),
			@StoredProcedureParameter(name = "PEMP_ID" ,mode = ParameterMode.IN,type=String.class),

	}, resultClasses = Annual_sample_plan_view_report_batchwise.class)
public class Annual_sample_plan_view_report_batchwise {
	@Id
	@Column(name = "ROW")
	private Long row;
	...
	public BigDecimal getBstock() {
		return bstock;
	}

	public void setBstock(BigDecimal bstock) {
		this.bstock = bstock;
	}
