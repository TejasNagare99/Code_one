...
@Entity
@Table(name = "Annual_sample_plan_view_report")
@NamedStoredProcedureQuery(name = "call_annual_sample_plan_view_report",
//procedureName = "ANNUAL_SAMPLE_PLAN_VIEW_REPORT_REVISED",
procedureName = "ANNUAL_SAMPLE_PLAN_VIEW_REPORT_REVISED_INMKT",
	parameters= {
	...
	}, resultClasses = Annual_sample_plan_view_report.class)
public class Annual_sample_plan_view_report {
