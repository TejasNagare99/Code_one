...
@Entity
@Table(name = "DispatchDetailReportRbmdm")
@NamedStoredProcedureQuery(name = "callDispatchDetailReportRbmdm", 
	procedureName = "dispatch_details_revised_rmdm",
	parameters = {
			...
			@StoredProcedureParameter(name = "rmdmmsr_flag" , mode = ParameterMode.IN, type = String.class),
			@StoredProcedureParameter(name = "rmdmmsr_fstaff_id" , mode = ParameterMode.IN, type = String.class),
			@StoredProcedureParameter(name = "isself" , mode = ParameterMode.IN, type = String.class),
	}, resultClasses = DispatchDetailReportRbmdm.class)
public class DispatchDetailReportRbmdm {
