...
public class Erp_tran_stock_Quarantine_recobean {
	...
	public void setOut_prod_code(String out_prod_code) {
		this.out_prod_code = out_prod_code;
	}
	public String getOut_prod_name() {
		return out_prod_name;
	}
