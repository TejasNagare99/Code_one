...
public interface PrintService {
	...
	List<ViewPrePrintedDetailChallan> getDeclarationForm(Integer divId, Integer locid, String frmchallan,
			String tochallan, String dispatchtype, String prodtype,String reptype, String finflag,String finId);
	//print

	List<ViewPrePrintedDetailChallan> getPreprintedSummaryChallanData(String division,String loc,String frm_challan,String to_challan,String prodtype,String rep_type,PrintBean bean)throws Exception;

	List<ViewPrePrintedSummaryChallan_GST> PrePrintedSummaryChallan_GSTdata(String division,String loc,String frm_challan,String to_challan,String prodtype,String rep_type,PrintBean bean)throws Exception;

	 Am_m_System_Parameter getSpValueForFooterSignature() throws Exception;
	 
	List<PrePrintedDetailChallan_withgst> getPreprintedDetailedChallanData(String division,String loc,String from_challan,String to_challan,String dispatchtype,String product_type,String rep_type,PrintBean bean) throws Exception;
	
	List<PrePrintedDetailChallan_withgst_pal> getPreprintedDetailedChallanDatapal(String division,String loc,String from_challan,String to_challan,String dispatchtype,String product_type,String rep_type,PrintBean bean) throws Exception;

	String getLocationNarrationByLocId(Long locId)throws Exception;	
	
	
	List<ViewPrePrintedDetailChallan> getViewPrePrintedDetailChallanData(String division,String loc,String frm_challan,String to_challan,String dispatchType,String prodtype,String rep_type,PrintBean bean)throws Exception;
	...
	List<Dispatch_Header> getChallanBtwStdtEndDtPkgList(String pageIndQuery,String ro, String divId, String periodCode, String finYear,
			String location, String finyrflg,String cnfLocation,HttpSession session);
	
	List<NOV_BillOfSupply_Challan> getChallanBtwStdtEndDtPkgList(PrintBean pb) throws Exception;
	...
	List<SWV_Header_arc> getstockwithdrawalpdfchallansforpreviousyear(Long loc_id, String period_code, String year,String page_ind)throws Exception;

	List<Dispatch_Header> getChallanListForGSTSummaryChallanPrintPrevious(String ro, String divId, String periodCode,
			String finYear, String location) throws Exception;
	
	List<PrePrintedDetailChallan_withgstPG> getPreprintedDetailedChallanDataPG(String division,String loc,String from_challan,String to_challan,String dispatchtype,String product_type,String rep_type,PrintBean bean) throws Exception;
	...
	//for stockist
	public List<ViewPrePrintedSummaryChallan_GST_EInvoiceStockist> PrePrintedSummaryChallan_GST_EInvoicedataStockist(String division, String loc,
			String frm_challan, String to_challan, String prodtype, String rep_type,PrintBean bean) throws Exception;

	List<Dispatch_Header> getChallanListForGSTSummaryChallanPrintStockist(String ro, String divId, String periodCode,
			String finYear, String location) throws Exception;
