...
@Service
public class FieldMasterResignedAudit_Report_ServiceImpl implements FieldMasterResignedAudit_Report_Service {
	...
	@Override
	public String getFieldMasterResignedReport(List<FieldMasterAttrib> list, String companyname, String username,
		...
		try {
			...
			filename = "fieldResignedAuditTrail_" + l+ ".xlsx" ;
			...
			SXSSFSheet wsheet = wwbook.createSheet("FieldMasterResignedAudittrail");
			...
			cell.setCellValue("Field Master Resigned Download");
	...
	@Override
	public String getFieldMasterResignedPrint(List<FieldMasterAttrib> list, String companyname, String username,
			AuditTrailBean bean, HttpSession session, HttpServletRequest request) throws Exception {
		...
		filename = "FieldResignedAudTrail" + timevar + ".pdf";
		StringBuffer path = null;
	...
	private PdfPTable createHeader(String comp_name, String username, String date, int rows)
			...
			PdfPCell title_2 = PdfStyle.createUltimateCellWithoutBorder(""
					+ "Field Master Resigned Audit Trail", 1, 5, 12, 18, false);
