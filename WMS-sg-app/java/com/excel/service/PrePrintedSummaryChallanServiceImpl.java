...
@Service
public class PrePrintedSummaryChallanServiceImpl implements PrePrintedSummaryChallanService,MedicoConstants{
	
	@Autowired PrintService printservice;
	
	ViewPrePrintedSummaryChallan_GST footer;
	@Autowired
...
@Autowired private UserMasterService userMasterService;
	...
	@Override
	public String PrePrintedSummaryChallanPrint(int division, Integer loc, String frm_challan, String to_challan,
			String dispatchType, String prodtype, String printtype, List<ViewPrePrintedSummaryChallan_GST> challans,
		...
		try {
		    ...
		    for (ViewPrePrintedSummaryChallan_GST challan : challans) {
			...
			List<ViewPrePrintedSummaryChallan_GST> list_new_page = new ArrayList<ViewPrePrintedSummaryChallan_GST>();
			isnew = true;
			for_new_page = true;
	 ...
	 private PdfPTable createHeader(ViewPrePrintedSummaryChallan_GST challan, int pagecount, int division, Integer loc,
...
//			else {
	...
	//		}
			...
			addressTbl_b.setWidths(new float[] { 1.5f, 6.5f });
...
//			  }
		  ...
		  headertable2.addCell(cell2);
			...
			PdfPCell hcell27 = new PdfPCell(PdfStyleNew
				.createLabelCellWithBorderSmallFontNoBoldTwiceHeight(
						challan.getDspstaff_email()!=null?
						(challan.getDspstaff_email().length() > 40
			...
			result2.append(System.lineSeparator());
			result2.append( challan.getStaff_addr4()!=null?(challan.getStaff_addr4().length() > 50 ?
					challan.getStaff_addr4().substring(0, 50).trim()
	...
	//		result2.append(System.lineSeparator());
		...
		//	result3.append(System.lineSeparator());
		    ...
		    public PdfPTable newPage(ColumnText column, PdfPTable bodytable, FooterWithoutPageNo event,
			    ...
			    String prodtype, String path, List<ViewPrePrintedSummaryChallan_GST> challan, String show_amount,
		    ...
		    private PdfPTable createFooter(HashMap<String, String> printLabel, boolean isFooterData, boolean pageflag,
			    ...
			    String dispatchType, String prodtype, String path, List<ViewPrePrintedSummaryChallan_GST> challan,
