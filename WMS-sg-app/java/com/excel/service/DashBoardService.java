...
public interface DashBoardService {
	...
	List<ActivityApproval> getTaskList(List<String> task_ids,String identitylink, String erp_cust_outstanding) throws ParseException, Exception;
	...
	List<DashboardCharts2> getDashboardPlanData(Long locId,String empId,String finyr,String periodCd,String divId) throws Exception;
	...
	String Generate_Fsdashboard_Report(List<FsDispatchLandingPage> fsData) throws Exception;
	...
	String genearetApprTrackinExcel(List<ApprovalTrackingData> data) throws Exception;
