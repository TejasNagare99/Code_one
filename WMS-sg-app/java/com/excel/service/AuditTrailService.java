...
public interface AuditTrailService {
	...
	List<GrnAuditTrailBean> getgrnAuditDownloadService(AuditTrailBean bean) throws Exception;
	List<DispatchAuditTrailBean> getDispatchAuditDownloadService(AuditTrailBean bean) throws Exception;
	List<ViewDownloadIaaAuditTrail> getViewDownloadIaaAuditTrialData(AuditTrailBean bean) throws Exception;
	
	List<GrnAuditTrailBean> getgrnAuditDownloadServicePrevious(AuditTrailBean bean) throws Exception;
	List<DispatchAuditTrailBean> getDispatchAuditDownloadServicePrevious(AuditTrailBean bean) throws Exception;
	
	List<Audit_log> getAuditLogData(String startDate,String endDate,String finYear,String finYearFlag);
