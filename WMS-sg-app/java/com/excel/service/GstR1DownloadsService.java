...
public interface GstR1DownloadsService {
	...
	String getGstR1Reports(ReportBean bean, String realPath, String compNm, List<ViewGSTR_1_B2CS_INV> b2cs_INV,List<ViewGSTR_1_B2CL_INV> b2cl_inv,List<ViewGSTR_1_HSN_INV> hsn_inv,
			List<ViewGSTR_1_B2CLA_INV> b2cla_inv,List<ViewGSTR_1_TRANSFER> transfer, List<GSTR_1_B2BA_INV> gstr_1_b2ba_invList,
			List<GSTR_1_B2B_INV> gstr_1_b2b_invList, List<ViewGSTR_1_B2CSA_INV> gstr_1_b2csa_inv)throws Exception;
}
